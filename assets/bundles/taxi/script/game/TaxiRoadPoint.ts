...
@ccclass("TaxiRoadPoint")
export class TaxiRoadPoint extends Component {
    ...
    @property({displayOrder: 4, visible:  function (this: TaxiRoadPoint){
        return this.moveType === ROAD_MOVE_TYPE.BEND;
    }})
    clockwise: boolean = false;

    @property({
        visible: function (this: TaxiRoadPoint) {
            return this.type === ROAD_POINT_TYPE.GREETING || this.type === ROAD_POINT_TYPE.GOODBYE;
        }
    })
    direction = new Vec3();

    @property({ displayOrder: 5, visible:  function (this: TaxiRoadPoint){
        return this.type === ROAD_POINT_TYPE.AI_START;
    }})
    delayTime = 0;

    @property({ displayOrder: 6, visible:  function (this: TaxiRoadPoint){
        return this.type === ROAD_POINT_TYPE.AI_START;
    }})
    interval = 3;

    @property({displayOrder: 7, visible:  function (this: TaxiRoadPoint){
        return this.type === ROAD_POINT_TYPE.AI_START;
    }})
    speed = 0.05;

    @property({ displayOrder: 8, visible:  function (this: TaxiRoadPoint){
        return this.type === ROAD_POINT_TYPE.AI_START;
    }})
    cars = '201';
