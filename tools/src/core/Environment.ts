...
class _Environment {
    ...
    readonly creatorPath: string = "D:/Cocos/Creator/2.4.7/resources";

    /**@description cocos creator 版本 */
    readonly creatorVerion: string = "2.4.7";

    /**@description 支持版本 */
    readonly supportVersions = ["2.4.0", "2.4.1", "2.4.2", "2.4.3", "2.4.4", "2.4.5", "2.4.6", "2.4.7","2.4.8","2.4.9","2.4.10","2.4.11","2.4.12","2.4.13"];
