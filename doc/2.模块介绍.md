...
[具体示例请参考示例：](https://gitee.com/top-discover/QuickFrameworkBundles/tree/2.4.7/bundles/nodePoolTest)
## 本地存储
...
- [参考示例](https://gitee.com/top-discover/QuickFrameworkBundles/blob/2.4.7/bundles/nodePoolTest/script/view/NodePoolView.ts)
### 视图管理器(UIManager) 
