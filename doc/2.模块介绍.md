...
- 1,添加语言包数据代理
- 2,移除语言包数据代理
- [参考示例](https://gitee.com/top-discover/QuickFramework/blob/2.4.3/assets/bundles/hall/script/HallEntry.ts#L11)
- 3,切换语言包代码数据源
- [参考示例](https://gitee.com/top-discover/QuickFramework/blob/2.4.3/assets/bundles/hall/script/data/HallLanguage.ts)
