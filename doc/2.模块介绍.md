...
- 1,添加语言包数据代理
- 2,移除语言包数据代理
- [参考示例](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/assets/bundles/hall/script/HallEntry.ts#L11)
- 3,切换语言包代码数据源
- [参考示例](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/assets/bundles/hall/script/data/HallLanguage.ts)
...
- [参考示例](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/assets/bundles/aimLine/script/view/AimLineView.ts)
### 视图管理器(UIManager) 
...
```
- 视图中集成了对声音播放的组件audioHelper,请参考[声音组件](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/doc/2.模块介绍.md#1声音组件audiocomponent)
