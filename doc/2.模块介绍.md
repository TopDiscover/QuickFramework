...
[具体示例请参考示例：](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/assets/bundles/nodePoolTest)
## 本地存储
...
```
- 视图中集成了对声音播放的组件audioHelper,请参考[声音组件](https://gitee.com/top-discover/QuickFramework/blob/3.1.0/doc/2.模块介绍.md#1声音组件audiocomponent)
