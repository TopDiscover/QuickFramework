...
```
## 7，编写主入口逻辑
- 如本项目中的**[LoginEntry](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/assets/scripts/login/LoginEntry.ts)**
- 参考代码
...
```
**到此，整个小白教程完成，如何创建自己的界面及bundle，更新详细的部分请参考[模块介绍](https://gitee.com/top-discover/QuickFramework/tree/3.1.0/doc/2.模块介绍.md)**