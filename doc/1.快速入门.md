...
[LoginLogic](https://gitee.com/top-discover/QuickFramework/blob/2.4.3/assets/scripts/login/LoginLogic.ts#L29)打开登录界面，
...
```
**到此，整个小白教程完成，如何创建自己的界面及bundle，更新详细的部分请参考[模块介绍](https://gitee.com/top-discover/QuickFramework/wikis/2.模块介绍.md)**