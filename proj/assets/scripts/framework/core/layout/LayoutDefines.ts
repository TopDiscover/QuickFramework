...
export class LayoutParam {
        ...
        if (isAlign) {
            ...
            if (isHorizontal) {
                ...
                if (this.isStretchWidth) {
                    // become stretch
                    this.result.originSize.width = this.node.width;
                }
            }
            else {
                ...
                if (this.isStretchHeight) {
                    // become stretch
                    this.result.originSize.height = this.node.height;
                }
            }
        }
        else {
            if (isHorizontal) {
                if (this.isStretchWidth) {
                    // will cancel stretch
                    this.node.width = this.result.originSize.width;
                }
            }
            else {
                if (this.isStretchHeight) {
                    // will cancel stretch
                    this.node.height = this.result.originSize.height;
                }
            }
    ...
    set node(v) {
        this.result.originSize.width = v.width;
        this.result.originSize.height = v.height;
        this._node = v;
    }
    /**@description 是否对齐上边。 */
    get isAlignTop() {
