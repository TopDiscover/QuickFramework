...
declare type UIView = import("../quick/scripts/framework/core/ui/UIView").default;
...
declare type Entry = import("../quick/scripts/framework/core/entry/Entry").Entry;
declare type Logic = import("../quick/scripts/framework/core/logic/Logic").Logic;
declare type GameView = import("../quick/scripts/framework/core/ui/GameView").default;
declare interface GameViewClass<T extends UIView> {
	new(): T;
	logicType: ModuleClass<Logic>;
}

declare type Sender = import("../quick/scripts/framework/core/net/service/Sender").Sender;
declare type Handler = import("../quick/scripts/framework/core/net/service/Handler").Handler;
declare type ReconnectHandler = import("../quick/scripts/framework/core/net/service/ReconnectHandler").ReconnectHandler;

declare type Service = import("../quick/scripts/framework/core/net/service/Service").Service;
...
declare function loadDirRes(config: {
	...
	/**@description 加载完成回调 */
	onComplete: (data: import("../quick/scripts/framework/core/asset/Resource").Resource.Cache) => void
	/**@description 目录资源url，传入此参数时，必须要提前加载此目录 */
	dir?: string,
}): void;
...
declare type EntryDelegate = import("../quick/scripts/framework/core/entry/EntryDelegate").EntryDelegate;
declare type Message = import("../quick/scripts/framework/core/net/message/Message").Message;
...
declare type ByteArray = import("../quick/scripts/framework/plugin/ByteArray").ByteArray;

declare type TableView = import("../quick/scripts/framework/core/ui/TableView").default;
