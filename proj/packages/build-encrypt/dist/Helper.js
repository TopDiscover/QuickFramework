...
class Helper {
    ...
    replaceResources() {
        ...
        let assetsPath = path_1.default.join(this.config.srcLabel, "assets");
        ...
        if (this._config.buildType == BuildTypeEnum.jsb_link) {
            ...
            //web 晚点写
            new ApplyWeb_1.ApplyWeb(this._config.encriptSign, this._config.encriptKey, this.config.srcLabel);
        }
